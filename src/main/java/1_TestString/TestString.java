...
//        System.out.println("调用startWith方法：" + a.startsWith("d"));
//        System.out.println("调用subString方法：" + a.substring(1));//指定开头，构造一个新的字符串
//        System.out.println("调用concat方法：" + a.concat("rrrrrrrr"));//在已有的字符串后面添加新的字符串
//        System.out.println("调用repalce方法：" + a.replace("r","aaaaaa"));//用新字符串替换原字符串中的相应字符串
...
//        System.out.println("调用repalceAll方法：" + a.replaceAll("r","aaaaaa"));//用新字符串替换原字符串中的相应字符串
...
//        System.out.println("调用hashcade方法：" + a.hashCode());
//        String shengfen = "湖北省";
